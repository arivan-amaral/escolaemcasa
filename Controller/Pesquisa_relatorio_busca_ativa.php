...
busca_ativa.aluno_id= aluno.idaluno $escola $turma  
and busca_ativa.data BETWEEN '$data_inicial' and '$data_final' GROUP BY  busca_ativa_id ORDER by registro_ligacao_busca_ativa.data DESC ");
