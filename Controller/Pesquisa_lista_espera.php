...
try { 
    ...
    $filtrar_tea = isset($_GET['filtrar_tea']) && $_GET['filtrar_tea'] == '1';
    $filtro_tea = $filtrar_tea ? " AND tipo_nec = 'tea' " : "";

    $result = "";
    $res = pesquisa_lista_espera($conexao, $sql_escolas, 2500, $pesquisa_nome_aluno, $filtro_tea);
    $conta = 1;
