...
try{
    ...
    $stmt = $conexao->prepare("INSERT INTO sua_tabela (aluno_id, periodo_inicial, periodo_final, quantidade_faltas, funcionario_id, quem_atendeu, descricao_chamada, exitosa, ficai) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
