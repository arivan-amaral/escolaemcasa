...
?>
 <tr style=''>
  ...
  center'><?php echo "$conta_aluno"; ?></span></p>
      ...
      padding:0cm 0cm 0cm 0cm;height:11.3pt;background-color: <?php echo "$cor_linha"; ?>;'>
      <p class=TableParagraph style='margin-top:1.8pt;margin-right:0cm;margin-bottom:
      0cm;margin-left:2.75pt;margin-bottom:.0001pt;'><span lang=PT ><?php echo "$sexo_aluno"; ?></span></p>
      </td>
      ...
      8.0pt;'><span lang=PT style='font-size:
      8.0pt;' ><?php echo "$data_nascimento"; ?></span></p>
      </td>
      ...
      0cm;margin-left:2.75pt;margin-bottom:.0001pt;font-size:
      8.0pt;'><span lang=PT style='font-size:
      8.0pt;'><?php echo "$data_matricula"; ?></span></p>
      </td>
      ...
      <p class=TableParagraph style='margin-top:1.8pt;margin-right:0cm;margin-bottom:
      0cm;margin-left:2.75pt;margin-bottom:.0001pt;font-size:
      8.0pt;'><span lang=PT ><?php echo ""; ?></span></p>
      </td>
...
?>
 ...
 <tr style='height:10.55pt'>
  ...
  <p class=TableParagraph align=center style='margin-top:5.45pt;margin-left:4.85pt;margin-bottom:1pt;margin-top:7pt;
  text-align:center'>
  ...
  text-align:center'>
  _____________________________________________________________<br>
  <span lang=PT style='font-size:10.0pt'>Assinatura do Diretor</span>
</p>
