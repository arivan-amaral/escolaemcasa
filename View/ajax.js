...
function lista_avaliacao_aluno_geral() {
  ...
  if (idperiodo != "" && idaluno != "") {
    ...
    xmlreq.open(
      "GET",
      "../Controller/Lista_avaliacao_aluno_por_data_geral.php?" + url,
      true
    );
...
function pesquisa_relatorio_busca_ativa() {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Pesquisa_relatorio_busca_ativa.php?" + url,
    true
  );
  xmlreq.onreadystatechange = function () {
    if (xmlreq.readyState == 4) {
...
function pesquisa_registro_ligacao() {
  ...
  var url =
    "escola_id=" + escola_id + "&turma_id=" + turma_id + "&ficai=" + ficai;
  // alert();
  result.innerHTML = "<center><img src='imagens/carregando.gif'></center>";
  xmlreq.open(
    "GET",
    "../Controller/Pesquisa_registro_ligacao.php?" + url,
    true
  );
  xmlreq.onreadystatechange = function () {
    if (xmlreq.readyState == 4) {
...
function criar_linha_para_cada_aluno_carteirinha() {
  ...
  checkboxes.forEach(function (checkbox) {
    ...
    linha_transporte = document.getElementById(
      checkbox.id + "_nome_linha"
    ).value;

    document.getElementById("carteirinha_linha_transporte").innerHTML +=
      "<div class='form-group'><label for='exampleInputEmail1'>Linha transporte para: " +
      nome +
      "</label>" +
      "<input type='text' class='form-control' id='" +
      input +
      "' name='linha_transporte_aluno[]' placeholder='Linha do transporte' readonly value='" +
      linha_transporte +
      "' oninput=alterar_input_linha_transporte(this.value," +
      input +
      "); >" +
      "</div>";
  });
  ...
  allCheckboxes.forEach(function (checkbox) {
    checkbox.addEventListener("change", function () {
      if (checkbox.checked) {
        document.getElementById("carteirinha_linha_transporte").innerHTML =
          "<div class='form-group'><label for='exampleInputEmail1'>Endereço</label>" +
          "<input type='text' class='form-control' id='" +
          input +
          "' name='endereco_escola' placeholder='Endereço da escola' required='>" +
          "</div>";
      } else {
...
function lista_espera() {
  ...
  var pesquisa = document.getElementById("escola").value;
  var pesquisa_nome_aluno = document.getElementById(
    "pesquisa_nome_aluno"
  ).value;
  ...
  xmlreq.open(
    "GET",
    "../Controller/Pesquisa_lista_espera.php?pesquisa=" +
      pesquisa +
      "&pesquisa_nome_aluno=" +
      pesquisa_nome_aluno,
    true
...
function buscar_dados_editar_lista(id) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Pesquisa_editar_lista_espera.php?id=" + id,
    true
  );
...
function aceita_recusar_lista_espera(id, status) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Aceita_lista_espera.php?id=" + id + "&status=" + status,
    true
  );
...
function questionar_chamada(id_chamado, id_funcionario, id_setor) {
  ...
  if (mensagem == "" || mensagem == null) {
    ...
    xmlreq.open(
      "GET",
      "../Controller/Questionar_chamada.php?chamada=" +
        chamada +
        "&funcionario=" +
        funcionario +
        "&mensagem=" +
    ...
    xmlreq.onreadystatechange = function () {
      if (xmlreq.readyState == 4) {
        if (xmlreq.status == 200) {
          texto.innerHTML =
            "<textarea type='text' class='form-control' rows='3' name='mensagem' id='mensagem' required='' disabled></textarea><br>";
          Swal.fire({
            position: "center",
            icon: "success",
            title: "Ação Concluída",
...
function total_notas(id) {
  ...
  var nota =
    parseFloat(nota_av1.value) +
    parseFloat(nota_av2.value) +
    parseFloat(nota_av3.value);

  if (parseFloat(nota_rp.value) > parseFloat(nota_av3.value)) {
    media_nota =
      parseFloat(nota) - parseFloat(nota_av3.value) + parseFloat(nota_rp.value);
  } else {
...
function pesquisa_chamado() {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Pesquisa_chamado.php?pesquisa=" + pesquisa,
    true
  );
...
function pesquisa_chamado_setor_escola() {
  ...
  if (
    ...
    xmlreq.open(
      "GET",
      "../Controller/Pesquisa_chamado_escola_status.php?pesquisa=" +
        pesquisa +
        "&data_inicial=" +
        data_inicial +
        "&data_final=" +
...
function relatorio_rendimento_funcao() {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Relatorio_rendimento_funcao.php?idescola=" +
      idescola +
      "&idturma=" +
      idturma +
      "&periodo=" +
...
function pesquisa_matricula_mensal() {
  ...
  if (data_inicial != "" && data_final != "") {
    if (excel != 1) {
      ...
      xmlreq.open(
        "GET",
        "../Controller/Pesquisa_matricula_mensal.php?excel=" +
          excel +
          "&serie=" +
          serie +
          "&data_inicial=" +
...
function pesquisa_relatorio_filtros() {
  ...
  if (texto == "") {
    ...
    xmlreq.open(
      "GET",
      "../Controller/Pesquisa_relatorio_filtro.php?excel=" +
        excel +
        "&operacao_cond_idade=" +
        operacao_cond_idade +
        "&operacao_idade=" +
...
function pesquisa_relatorio_filtros_aee() {
  const baixar_excel = document.querySelector("#baixar_excel");
  if (baixar_excel.checked) {
    var excel = 1;
  } else {
...
if (excel !=1) {
  ...
  if (texto == "") {
    ...
    xmlreq.open(
      "GET",
      "../Controller/Pesquisa_relatorio_filtro_aee.php?excel=" +
        excel +
        "&operacao_cond_idade=" +
        operacao_cond_idade +
        "&operacao_idade=" +
...
function cadastrar_resposta_mensagem(id_mensagem, id_funcionario, mensagem) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Cadastrar_resposta_mensagem.php?mensagem=" +
      mensagem +
      "&id_funcionario=" +
      id_funcionario +
      "&id_mensagem=" +
...
function enviar_resposta_sme(id) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Resposta_sme.php?mensagem=" + mensagem + "&id=" + id,
    true
  );
...
function cadastrar_mensagem(id_chamada, enviado) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Cadastrar_mensagem.php?mensagem=" +
      mensagem +
      "&enviado=" +
      enviado +
      "&id_chamada=" +
...
function relatorio_rendimento_turma_funcao() {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Listar_turma_relatorio_rendimento.php?idescola=" + idescola,
    true
  );
...
function alterar_situacao_aluno(matricula, element) {
  ...
  Swal.fire({
    ...
    xmlreq.open(
      "GET",
      "../Controller/Mudar_situacao_aluno.php?data=" +
        data +
        "&matricula=" +
        matricula +
        "&status=" +
...
function ver_resolvidos(setor_id) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Listar_chamados_resolvidos.php?setor_id=" + setor_id,
    true
  );
...
function licitalem_webhook() {
  ...
  xmlreq.open(
    "POST",
    "https://educalem.com.br/licitalem/Controller/Api_licitacao.php",
    true
  );
  xmlreq.onreadystatechange = function () {
    if (xmlreq.readyState == 4) {
...
function licitalem_webhook() {
  ...
  xmlreq.open(
    "POST",
    "../Controller/Notificacao_ocorrencia_whatsapp.php",
    true
  );
  xmlreq.onreadystatechange = function () {
    if (xmlreq.readyState == 4) {
...
function excluir_notas_cadastrada_fora(idnota) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      xmlreq.open(
        "GET",
        "../Controller/Excluir_notas_cadastrada_fora.php?idnota=" + idnota,
        true
      );
      xmlreq.onreadystatechange = function () {
        if (xmlreq.readyState == 4) {
...
function mudar_ano_letivo(ano) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Muda_ano_letivo.php?muda_ano_letivo=" + ano,
    true
  );
  xmlreq.onreadystatechange = function () {
    if (xmlreq.readyState == 4) {
...
function finalizar_chat(chamada) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Finalizar_chamado.php?id_chamado=" + id_chamado,
    true
  );
  xmlreq.onreadystatechange = function () {
    if (xmlreq.readyState == 4) {
...
function lista_notas_cadastrada_fora() {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Lista_notas_cadastrada_fora.php?idaluno=" + idaluno,
    true
  );
...
function view_nota_fora_rede_ano_finalizado(opcao) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/View_registro_nota_fora_rede.php?opcao=" + opcao,
    true
  );
...
function pesquisar_solicitacao_transferencia_por_escola() {
  var quantidade_pedido_transferencia = document.getElementById(
    "quantidade_pedido_transferencia"
  );
  ...
  xmlreq.open(
    "GET",
    "../Controller/Pesquisar_solicitacao_transferencia_por_escola.php",
    true
  );
...
function bloquear_botao_concluir(botao) {
  setTimeout(function () {
    ...
    document.getElementById(botao).innerHTML =
      "AGUARDE 20 SEGUNDOS, PARA CLICAR NOVAMENTE ";
  }, 50);
...
function cadastro_aluno() {
  ...
  var nome_responsavel =
    document.getElementsByName("nome_responsavel")[0].value;
  var data_matricula = document.getElementsByName("data_matricula")[0].value;
  var whatsapp_responsavel = document.getElementsByName(
  ...
  if (!!document.getElementsByName("uf_municipio_cartorio")) {
    ...
    var uf_municipio_cartorio = document.getElementsByName(
  ...
  if (!!document.getElementsByName("municipio_endereco")) {
    ...
    var municipio_endereco =
      document.getElementsByName("municipio_endereco")[0].value;
  }
...
function listar_vagas_turma_transferencia_aluno() {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Listar_vagas_turma_transferencia_aluno.php?escola=" +
      escola +
      "&serie=" +
      serie,
    true
...
function pesquisa_aluno() {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Pesquisar_aluno.php?pesquisa=" +
      pesquisa +
      "&escola=" +
      escola,
    true
  ...
  xmlreq.onreadystatechange = function () {
    if (xmlreq.readyState == 4) {
      if (xmlreq.status == 200) {
        result.innerHTML = xmlreq.responseText;
        paginacao.innerHTML =
          "<button onclick='pesquisa_aluno_paginacao();' class='btn btn-block btn-default btn-sm'>Ver mais resultados</button> ";
      } else {
        alert("Erro desconhecido, verifique sua conexão com a internet");
  ...
  xmlreq.onreadystatechange = function () {
    if (xmlreq.readyState == 4) {
      if (xmlreq.status == 200) {
        if (xmlreq.responseText == "certo") {
          result.innerHTML =
            "<a class='btn btn-success'> APC </A> <a class='btn btn-danger' onclick='cancelar_aprovacao_concelho(" +
            idaluno +
            ");'> Cancelar APC</a>";
        } else {
          alert("Erro, tente novamente");
          result.innerHTML =
            "<a class='btn btn-primary' onclick='aprovar_concelho(" +
            idaluno +
            ");'> Aprovar pelo conselho</a>";
        }
      } else {
  ...
  xmlreq.onreadystatechange = function () {
    if (xmlreq.readyState == 4) {
      if (xmlreq.status == 200) {
        if (xmlreq.responseText == "certo") {
          result.innerHTML =
            "<a class='btn btn-danger' onclick='desmarcar_aluno_evadido(" +
            matricula +
            ");'>DESMARCAR DE EVADIDO </a>";
        } else {
          alert("Erro, tente novamente");
          result.innerHTML =
            "<a class='btn btn-primary' onclick='marcar_como_evadido(" +
            matricula +
            ");'>MARCAR COMO EVADIDO </a>";
        }
      } else {
        alert("Atenção: " + xmlreq.responseText);
  ...
  xmlreq.onreadystatechange = function () {
    if (xmlreq.readyState == 4) {
      if (xmlreq.status == 200) {
        if (xmlreq.responseText == "certo") {
          result.innerHTML =
            "<a class='btn btn-primary' onclick='marcar_aluno_evadido(" +
            matricula +
            ");'>MARCAR COMO EVADIDO </a>";
        } else {
          alert("Erro, tente novamente");
...
function cancelar_aprovacao_concelho(idaluno) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Cancelar_aprovacao_conselho.php?" + url,
    true
  );
...
function adicinar_campo_conteudo(idcampo) {
  ...
  if (valor == true) {
    ...
    xmlreq.open(
      "GET",
      "../Controller/Verifica_conteudo.php?aula=" +
        aula +
        "&data=" +
        data +
        "&valor_input=" +
...
function muda_etapa(idaluno) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Muda_etapa_multissereada.php?etapa=" +
      etapa +
      "&idaluno=" +
      idaluno,
    true
...
function listar_etapas_cad_aluno() {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Lista_etapa_multissereada.php?idserie=" +
      idturma +
      "/" +
      idserie,
    true
...
function listar_etapas(idserie) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Lista_etapa_multissereada.php?idserie=" + idserie,
    true
  );
...
function receber_resenha() {
  ...
  var trabalho_entregue_id = document.getElementById(
    "trabalho_entregue_id"
  ).value;
  var aluno_id = document.getElementById("aluno_id").value;
  var url =
    "trabalho_entregue_id=" + trabalho_entregue_id + "&aluno_id=" + aluno_id;

  var xmlreq = CriaRequest();
  xmlreq.open(
    "GET",
    "../Controller/Resenha_trabalho_entregue_receber.php?" + url,
    true
  );
...
function mudar_escola_simulado(id) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Mudar_escola_simulado.php?idescola=" +
      idescola +
      "&idquestionario=" +
      id,
    true
...
function enviar_resenha() {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Resenha_trabalho_entregue_enviar.php?" + url,
    true
  );
...
function colar_conteudo_ja_cadastrados(conteudo) {
  Swal.fire({
    title:
      "Deseja COLAR  o conteúdo selecionado nessa FREQUÊNCIA a ser cadastrada/editada?",
    showDenyButton: true,
    confirmButtonText: `Sim`,
    denyButtonText: `Não`,
  }).then((result) => {
    ...
    if (result.isConfirmed) {
      ...
      Swal.fire(
        "Texto copiado para área de transferência! Ctrl+V em algum local para colar.",
        "",
        "info"
      );
    } else if (result.isDenied) {
...
function excluir_frequencia(id) {
  ...
  var url =
    "local=" + local + "&conteudo_aula_id=" + conteudo_aula_id + "&" + url_get;
  Swal.fire({
...
function notificacao_mural_whatsapp(cont) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Notificacao_mural_whatsapp.php?turma_id=" +
      turma_id +
      "&escola_id=" +
      escola_id +
      "&serie_id=" +
...
function notificacao_trabalho_whatsapp(cont) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Notificacao_trabalho_whatsapp.php?turma_id=" +
      turma_id +
      "&escola_id=" +
      escola_id +
      "&serie_id=" +
...
function notificacao_video_whatsapp(cont) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Notificacao_video_whatsapp.php?turma_id=" +
      turma_id +
      "&escola_id=" +
      escola_id +
      "&serie_id=" +
...
function lista_avaliacao_ja_cadastrada_por_periodo(periodo) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Lista_avaliacao_aluno_por_periodo.php?" + url,
    true
  );
  xmlreq.onreadystatechange = function () {
    if (xmlreq.readyState == 4) {
...
function liberar_questionario(idaluno, idquestionario) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      xmlreq.open(
        "GET",
        "../Controller/Liberar_questionario.php?idaluno=" +
          idaluno +
          "&idquestionario=" +
          idquestionario,
        true
      ...
      xmlreq.onreadystatechange = function () {
        if (xmlreq.readyState == 4) {
          if (xmlreq.status == 200) {
            // result.innerHTML =  xmlreq.responseText;
            resultado.innerHTML =
              "<b class='text-danger'>Questionário não finalizado.</b><br>";
          } else {
...
function lista_ocorrencia_aluno() {
  ...
  var data_ocorrencia_lancada = document.getElementById(
    "data_ocorrencia_lancada"
  ).value;
...
function lista_conteudo_aluno() {
  ...
  var idturma = document.getElementById("idturma").value;
  var iddisciplina = document.getElementById("iddisciplina").value;
  var descricao_escola_turma = document.getElementById(
    "descricao_escola_turma"
  ).innerHTML;
  ...
  if (aula != "" && data_frequencia != "") {
    ...
    xmlreq.open(
      "GET",
      "../Controller/Lista_conteudo_cadastrados.php?" + url,
      true
    );
    xmlreq.onreadystatechange = function () {
      if (xmlreq.readyState == 4) {
...
function editar_avaliacao_aluno_por_data(conta) {
  ...
  if (data_avaliacao != "" && idperiodo != "" && avaliacao != "") {
    ...
    xmlreq.open(
      "GET",
      "../Controller/Lista_avaliacao_aluno_por_data.php?" + url,
      true
    );
    xmlreq.onreadystatechange = function () {
      if (xmlreq.readyState == 4) {
...
function lista_de_turmas(id) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Lista_de_turmas_por_serie.php?serie_id=" + id,
    true
  );
  xmlreq.onreadystatechange = function () {
    if (xmlreq.readyState == 4) {
...
function lista_turma_escola_por_serie(campo_listagem) {
  ...
  var quantidade_vagas_restante = document.getElementById(
  ...
  xmlreq.open(
    "GET",
    "../Controller/Lista_de_turmas_por_escola_serie.php?turma_id=" +
      turma_id +
      "&rematricula=sim&turno=" +
      turno +
      "&escola_id=" +
      escola_id +
      "&serie_id=" +
...
function pesquisar_por_nome_carteirinha_escola() {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Pesquisar_por_nome_carteirinha_escola.php?nome_aluno=" +
      nome_aluno,
    true
  );
  xmlreq.onreadystatechange = function () {
...
function lista_carteirinha_escola() {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Lista_carteirinha_escola.php?idescola=" +
      idescola +
      "&idturma=" +
      idturma,
    true
...
function lista_turma_escola_por_serie_escola_individual(idaluno) {
  var quantidade_vagas_restante = document.getElementById(
    "quantidade_vagas_restante" + idaluno
  );
  var result = document.getElementById("lista_de_turmas_rematricula" + idaluno);

  var escola_id = document.getElementById(
    "rematricula_escola_id" + idaluno
  ).value;
  ...
  var turma_id = document.getElementById(
    "lista_de_turmas_rematricula" + idaluno
  ).value;
  ...
  xmlreq.open(
    "GET",
    "../Controller/Lista_de_turmas_cadastrada_por_escola_serie_cadastro_aluno.php?turma_id=" +
      turma_id +
      "&rematricula=sim&turno=" +
      turno +
      "&escola_id=" +
...
function quantidade_vaga_turma(campo_listagem) {
  ...
  if (campo_listagem == "troca_turma") {
    var quantidade_vagas_restante = document.getElementById(
      "quantidade_vagas_restante_troca_turma"
    );
  ...
  xmlreq.onreadystatechange = function () {
    if (xmlreq.readyState == 4) {
      if (xmlreq.status == 200) {
        ...
        var botaoSubmit = document.getElementById(
          "btn_botao_continuar_troca_turma"
        );
...
function lista_turma_cadastrada_escola_por_serie(campo_listagem) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Lista_de_turmas_cadastrada_por_escola_serie.php?turno=" +
      turno +
      "&escola_id=" +
      escola_id +
      "&serie_id=" +
...
function adicionar_turma_escola() {
  ...
  if (
    ...
    xmlreq.open(
      "GET",
      "../Controller/Cadastrar_turma_escola.php?escola=" +
        escola +
        "&turno=" +
        turno +
        "&serie=" +
...
function alterar_valor_vagas(
  ...
  xmlreq.open(
    "GET",
    "../Controller/Alterar_vagas.php?escola=" +
      escola_id +
      "&id=" +
      id +
      "&turma=" +
...
function listar_opcao_associacao_coordenador(id) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/View_associar_coordenador_a_escola.php?idcoordenador=" + id,
    true
  );
  xmlreq.onreadystatechange = function () {
    if (xmlreq.readyState == 4) {
...
function listar_opcao_associacao_professor(id) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/View_associar_professor_turma_disciplina.php?idprofessor=" +
      id,
    true
  );
  xmlreq.onreadystatechange = function () {
...
function pesquisar_coordenador_associacao() {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Pesquisar_coordenador_associacao.php?pesquisa=" + pesquisa,
    true
  );
  xmlreq.onreadystatechange = function () {
    if (xmlreq.readyState == 4) {
...
function pesquisar_professor_associacao() {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Pesquisar_professor_associacao.php?pesquisa=" + pesquisa,
    true
  );
  xmlreq.onreadystatechange = function () {
    if (xmlreq.readyState == 4) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      window.location.href =
        "../Controller/Alterar_status_questionario_simulado.php?id=" +
        id +
        "&status=" +
        status +
        "";
...
function alterar_status_questionario(id, status) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      window.location.href =
        "../Controller/Alterar_status_questionario.php?id=" +
        id +
        "&status=" +
        status +
        "";
...
function excluir_questionario(id) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      xmlreq.open(
        "GET",
        "../Controller/Excluir_questionario.php?id=" + id,
        true
      );
      xmlreq.onreadystatechange = function () {
        if (xmlreq.readyState == 4) {
...
function excluir_nota_duplicada(id) {
  Swal.fire({
    title:
      "Deseja continuar com a EXCLUSÃO dessa nota? Favor deixar ao menos uma nota sem excluir!",
    showDenyButton: true,
    confirmButtonText: `Sim`,
    denyButtonText: `Não`,
  }).then((result) => {
    ...
    if (result.isConfirmed) {
      ...
      xmlreq.open(
        "GET",
        "../Controller/Excluir_nota_duplicada.php?id=" + id,
        true
      );
      xmlreq.onreadystatechange = function () {
        if (xmlreq.readyState == 4) {
...
function excluir_questionario_simulado(id) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      xmlreq.open(
        "GET",
        "../Controller/Excluir_questionario_simulado.php?id=" + id,
        true
      );
      xmlreq.onreadystatechange = function () {
        if (xmlreq.readyState == 4) {
...
function excluir_questao_simulado(id) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      xmlreq.open(
        "GET",
        "../Controller/Excluir_questao_simulado.php?id=" + id,
        true
      );
      xmlreq.onreadystatechange = function () {
        if (xmlreq.readyState == 4) {
...
function excluir_professor(id) {
  ...
  Swal.fire({
    title:
      "Tem certeza que deseja EXCLUIR o professor(a): " + nome_professor + "?",
    ...
    if (result.isConfirmed) {
      window.location.href =
        "../Controller/Excluir_professor.php?id=" + id + "";
    } else if (result.isDenied) {
...
function excluir_coordenador(id) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      window.location.href =
        "../Controller/Excluir_coordenador.php?id=" + id + "";
    } else if (result.isDenied) {
      //Swal.fire('Ação não concluída', '', 'info')
    }
  });
...
function cancelar_associacao_coordenador(id) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      window.location.href =
        "../Controller/Desassociar_coordenador.php?idrelacionamento_funcionario_escola=" +
        id +
        "";
    } else if (result.isDenied) {
      //Swal.fire('Ação não concluída', '', 'info')
...
function cancelar_associacao_professor(id) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      xmlreq.open(
        "GET",
        "../Controller/Desassociar_professor.php?id=" + id,
        true
      );
      xmlreq.onreadystatechange = function () {
        if (xmlreq.readyState == 4) {
...
function excluir_link_video_chamada(id) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      xmlreq.open(
        "GET",
        "../Controller/Excluir_link_video_chamada.php?id=" + id,
        true
      );
      xmlreq.onreadystatechange = function () {
        if (xmlreq.readyState == 4) {
...
function excluir_trabalho_aluno(id) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      window.location.href =
        "../Controller/Excluir_trabalho_aluno.php?id=" + id + "&" + url_get;
    } else if (result.isDenied) {
      // Swal.fire('Não foi excluido', '', 'info')
    }
  });
...
function excluir_material_apoio(id) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      window.location.href =
        "../Controller/Excluir_material_apoio.php?id=" + id + "&" + url_get;
    } else if (result.isDenied) {
      // Swal.fire('Não foi excluido', '', 'info')
    }
  });
...
function resultado_questao_simulado() {
  ...
  var paginacao = (document.getElementById("paginacao").style.display =
    "block");
  //result.innerHTML="<img src='imagens/carregando.gif'>";
  aguarde();
  ...
  xmlreq.open(
    "GET",
    "../Controller/Lista_aluno_baixar_simulado.php?indice=" +
      pagina +
      "&serie_id=" +
      serie_id +
      "&escola_id=" +
...
function resultado_questao() {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Lista_aluno_baixar_prova.php?escola_id=" +
      escola_id +
      "&aluno=" +
      aluno +
      "&questionario=" +
...
function resposta_discursiva(id) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Responder_questionario_discursiva.php?texto=" +
      texto +
      "&id=" +
      idalternativa +
      "&disciplina_id=" +
  ...
  xmlreq.onreadystatechange = function () {
    if (xmlreq.readyState == 4) {
      if (xmlreq.status == 200) {
        ...
        nao_salvo.innerHTML =
          "Erro ao Salvar, verifique sua conexão com a internet!";
        result.innerHTML = "";
...
function resposta_multipla_professor(id) {
  var origem_questionario_id = document.getElementById(
    "origem_questionario_id"
  ).value;
  var texto_alternativa = document.getElementById("alternativa" + id).value;
  var xmlreq = CriaRequest();
  xmlreq.open(
    "GET",
    "../Controller/Responder_questionario_discursiva_professor.php?origem_questionario_id=" +
      origem_questionario_id +
      "&id=" +
      id +
      "&texto_alternativa=" +
...
function resposta_multipla_professor_simulado(id) {
  ...
  var questao_alternativa = document.getElementById(
    "questao_alternativa" + id
  ).value;
  var xmlreq = CriaRequest();
  xmlreq.open(
    "GET",
    "../Controller/Responder_questionario_discursiva_professor_simulado.php?questao_alternativa=" +
      questao_alternativa +
      "&origem_questionario_id=" +
      origem_questionario_id +
      "&id=" +
  ...
  xmlreq.onreadystatechange = function () {
    if (xmlreq.readyState == 4) {
      if (xmlreq.status == 200) {
        ...
        alert("Erro, verifique sua conexão com a internet!");
        link_erro.innerHTML =
          "Ocorreu um erro, acesse o link abaixo, vai aparecer uma mensagem (CERTO) <BR> <a target='_blank' href='../Controller/Responder_questionario_discursiva_professor_simulado.php?questao_alternativa=" +
          questao_alternativa +
          "&origem_questionario_id=" +
          origem_questionario_id +
          "&id=" +
          ...
          "&texto_alternativa=" +
          texto_alternativa +
          "'> Clique aqui para Marcar essa questão</a>";
      }
    }
  };
  xmlreq.send(null);
...
function resposta_multipla_simulado(id, questao_id) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Responder_questionario_discursiva_simulado.php?texto=&questao_id=" +
      questao_id +
      "&idalternativa=" +
      id +
      "&texto_alternativa=" +
...
function resposta_justificada_simulado(id) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Responder_questionario_discursiva_professor_simulado.php?texto=" +
      texto +
      "&id=" +
      idalternativa +
      "&disciplina_id=" +
...
function alterar_data_questionario(id) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Alterar_data_questionario.php?id=" +
      id +
      "&data=" +
      data +
      "&data_fim=" +
...
function alterar_horario_individual_questionario(idaluno) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Alterar_horario_individual_questionario.php?" + url,
    true
  );
  xmlreq.onreadystatechange = function () {
    if (xmlreq.readyState == 4) {
      if (xmlreq.status == 200) {
        ...
        result.innerHTML =
          "<b class='text-danger'>Erro ao alterar horário</b><br>";
...
function cadastra_horario_individual_questionario(idaluno) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Cadastrar_horario_individual_questionario.php?idaluno=" +
      idaluno +
      "&hora_inicio=" +
      hora_inicio +
      "&hora_fim=" +
...
function alterar_data_simulado(id) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Alterar_data_simulado.php?id=" +
      id +
      "&data=" +
      data +
      "&data_fim=" +
...
function alterar_pergunta_discursiva(id) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Alterar_pergunta_discursiva.php?texto_questao=" +
      texto_questao +
      "&id=" +
      id,
    true
  ...
  xmlreq.onreadystatechange = function () {
    if (xmlreq.readyState == 4) {
      if (xmlreq.status == 200) {
        result.innerHTML =
          "<b class='alert alert-success'>Editado com Sucesso!</b>";
      } else {
        //alert('Erro');
      }
    }
...
function relatorio_de_visualizacao_video_coordenador(idaluno) {
  var result = document.getElementById(
    "relatorio_de_visualizacao_video" + idaluno
  );
  result.innerHTML = "";
  ...
  xmlreq.open(
    "GET",
    "../Controller/Relatorio_de_visualizacao_video_coordenador.php?idaluno=" +
      idaluno,
    true
  );
  xmlreq.onreadystatechange = function () {
...
function relatorio_de_visualizacao_video(idaluno, idturma, iddisciplina) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Relatorio_de_visualizacao_video.php?idaluno=" +
      idaluno +
      "&idturma=" +
      idturma +
      "&iddisciplina=" +
...
function visualizacao_video(idvideo, id_aluno) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Visualizacao_video.php?idvideo=" +
      idvideo +
      "&id_aluno=" +
      id_aluno,
    true
...
function listar_alunos_trabalho(idtrabalho, idturma, iddisciplina) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Listar_alunos_trabalho.php?idescola=" +
      idescola +
      "&idtrabalho=" +
      idtrabalho +
      "&idturma=" +
...
function atualiza_data_hora_video(idvideo) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Alterar_data_video.php?idvideo=" +
      idvideo +
      "&data=" +
      data +
      "&hora=" +
...
function mudar_status_aluno(status, id) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Mudar_status_aluno.php?id=" + id + "&status=" + status,
    true
  );
  xmlreq.onreadystatechange = function () {
...
function pesquisa_cliente(pesquisa) {
  ...
  result.innerHTML =
    "<center><div class='overlay'><i class='fas fa-3x fa-sync-alt'></i></div></center>";

  xmlreq.open(
    "GET",
    "../Controller/Pesquisa_cliente.php?pesquisa=" + pesquisa,
    true
  );
...
function pesquisa_funcionario(pesquisa) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Pesquisa_funcionario.php?pesquisa=" + pesquisa,
    true
  );
...
function pesquisa_produto(pesquisa) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Pesquisa_produto.php?pesquisa=" + pesquisa,
    true
  );
...
function chat_receber_professor() {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Chat_receber_professor.php?turma_id=" +
      turma_id +
      "&escola_id=" +
      escola_id,
    true
...
function chat_enviar() {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Chat_enviar.php?mensagem=" + mensagem_enviar,
    true
  );
...
function chat_enviar_professor() {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Chat_enviar_professor.php?mensagem=" +
      mensagem_enviar +
      "&turma_id=" +
      turma_id +
      "&escola_id=" +
...
function listar_turma_escola_relatorio() {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Listar_turma_escola_carterinha.php?idescola=" + idescola,
    true
  );
...
function listar_turmas_coordenador(idescola) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Listar_turmas_coordenador.php?idescola=" + idescola,
    true
  );
...
function listar_turmas_por_serie(idserie) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Listar_turmas_por_serie.php?idserie=" + idserie,
    true
  );
...
function quantidade_vaga_turma_cadastro_aluno() {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Quantidade_vaga_turma.php?turma_id=" +
      turma_id +
      "&rematricula=não&turno=" +
      turno +
      "&escola_id=" +
...
function quantidade_vaga_turma_rematricula_individual(idaluno) {
  ...
  var idserie = document.getElementById(
    "rematricula_nova_serie" + idaluno
  ).value;
  var turno = document.getElementById("rematricula_turno" + idaluno).value;
  var turma_id = document.getElementById(
    "lista_de_turmas_rematricula" + idaluno
...
function rematricular_aluno_individual(idaluno) {
  ...
  var turma_id_anterior = document.getElementById(
    "turma_id_anterior" + idaluno
  ).value;
  var quantidade_vagas_restante = document.getElementById(
    "quantidade_vagas_restante" + idaluno
  ).value;
  ...
  var rematricula_nova_serie = document.getElementById(
    "rematricula_nova_serie" + idaluno
  ).value;
  var rematricula_serie_id = document.getElementById(
    "rematricula_serie_id" + idaluno
  ).value;
  var turma_escola = document.getElementById(
    "rematricula_escola_id" + idaluno
  ).value;
  ...
  xmlreq.open(
    "GET",
    "../Controller/Rematricular_aluno_individual.php?" + url,
    true
  );
  xmlreq.onreadystatechange = function () {
    if (xmlreq.readyState == 4) {
...
function excluir_aluno_matriculado(idaluno) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      xmlreq.open(
        "GET",
        "../Controller/Excluir_aluno_matriculado.php?idaluno=" +
          idaluno +
          "&matricula=" +
          matricula,
        true
...
function cancelar_rematricula(idaluno) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      xmlreq.open(
        "GET",
        "../Controller/Cancelar_rematricula.php?idaluno=" +
          idaluno +
          "&matricula=" +
          matricula,
        true
...
function cancelar_transferencia(idaluno, matricula) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      xmlreq.open(
        "GET",
        "../Controller/Cancelar_transferencia.php?idaluno=" +
          idaluno +
          "&matricula=" +
          matricula,
        true
...
function troca_de_turma_escola_por_serie() {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Lista_de_turmas_cadastrada_por_escola_serie_cadastro_aluno.php?turma_id=&rematricula=não&turno=" +
      turno +
      "&escola_id=" +
      escola_id +
      "&serie_id=" +
...
function mudar_bloqueio_funcionario(campo) {
  ...
  var result = document.getElementById(
    "aguarde" + idcalendario + "" + idfuncionario
  );
  var input = document.getElementById(
    "calendario" + idcalendario + "" + idfuncionario
  );
  var campo_status = document.getElementById(
    "status" + idcalendario + "" + idfuncionario
  );
  ...
  xmlreq.open(
    "GET",
    "../Controller/Mudar_bloqueio_funcionario.php?" + url,
    true
  );
  xmlreq.onreadystatechange = function () {
    if (xmlreq.readyState == 4) {
...
function listar_turma_aceita_transferencia(idsolicitacao) {
  var aceitar_idescola_destino = document.getElementById(
    "aceitar_idescola_destino" + idsolicitacao
  ).value;
  var aceitar_ano_letivo = document.getElementById(
    "aceitar_ano_letivo" + idsolicitacao
  ).value;
  var aceitar_turno = document.getElementById(
    "aceitar_turno" + idsolicitacao
  ).value;
  var aceitar_idserie_destino = document.getElementById(
    "aceitar_idserie_destino" + idsolicitacao
  ).value;
  var vaga_escola = document.getElementById("vaga_escola" + idsolicitacao);
  var aceitar_nova_turma = document.getElementById(
    "aceitar_nova_turma" + idsolicitacao
  );
  ...
  xmlreq.open(
    "GET",
    "../Controller/Listar_turma_aceita_transferencia.php?" + url,
    true
  );
  xmlreq.onreadystatechange = function () {
    if (xmlreq.readyState == 4) {
...
function aceitar_solicitacao_transferencia(form1) {
  var formData = new FormData(
    document.getElementById("aceita_solicitacao" + form1)
  );
  $.ajax({
    type: "POST",
    ...
    success: function (msg) {
      ...
      if (msg == "Ação concluída") {
        ...
        setTimeout(function () {
          window.location.href = "lista_solicitacao_transferencia.php";
        }, 1000);
      } else {
        Swal.fire({
          position: "center",
...
function rejeitar_solicitacao_transferencia(form1) {
  var formData = new FormData(
    document.getElementById("rejeita_solicitacao" + form1)
  );
  var descricao_regeitar_solicitacao = document.getElementById(
    "descricao_regeitar_solicitacao" + form1
  ).value;
...
function quantidade_vaga_restante_transferencia_turma(idsolicitacao) {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Quantidade_vaga_restante_transferencia_turma.php?" + url,
    true
  );
  xmlreq.onreadystatechange = function () {
    if (xmlreq.readyState == 4) {
...
function pesquisa_frequencia() {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Relatorio_de_frequencia.php?idescola=" +
      idescola +
      "&idturma=" +
      idturma +
      "&falta=" +
...
function pesquisa_relatorio_faltas_aluno() {
  ...
  xmlreq.open(
    "GET",
    "../Controller/Pesquisa_relatorio_faltas_aluno.php?idescola=" +
      idescola +
      "&idturma=" +
      idturma +
      "&falta=" +
...
function pesquisa_id_carterinha_aluno() {
  // Obtém todos os checkboxes com classe iniciada por "idtuma"
  const checkboxes = document.querySelectorAll(
    'input[type="checkbox"].carterinha_aluno'
  );
  ...
  window.location.href =
    "imprimir_carteirnha_selecionada.php?idaluno=" + idaluno;
}
