            ...
            <input type="hidden" name="turma_id_origem" id="turma_id_origem" value="<?php echo $idturma; ?>">
                 <div class="col-sm-3">
                  <div class="form-group">
                    ...
                    <input type="date" name="data_transferencia"  value="<?php echo date("Y-m-d"); ?>" required class="form-control">
                   <p class="text-danger ">Essa data implicará apenas nas tranferências para fora da rede.</p>
                </div>
              </div>  
