...
foreach ($result as $key => $value) {
  ...
  $result_ocorrencia=$conexao->query("SELECT * FROM ocorrencia_pedagogica,aluno where aluno_id=aluno.idaluno and disciplina_id=$iddisciplina and turma_id=$idturma and descricao !='' and  aluno_id=$idaluno and ano='$ano_letivo' ORDER BY data_ocorrencia ASC");
