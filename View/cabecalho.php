 ...
 <body>
     <div class="container">
         <h1>Concluindo Migração</h1>
         <p>
             Estamos finalizando o processo de migração da instância do servidor.  
             Pedimos desculpas pelo inconveniente causado.  
         </p>
         <p>
             Em instantes, o sistema estará de volta, com maior estabilidade e performance.
         </p>
         <p class="footer">
             Agradecemos pela sua paciência e compreensão.<br>
             <strong>Equipe ValletecLab</strong>
         </p>
     </div>
 </body>
 </html>
