<?php
 ...
 function diario_conteudo_fund2($conexao,$idescola,$idturma,$iddisciplina,$idserie,$nome_disciplina,$nome_professor,$nome_turma,$nome_escola,$data_inicial,$data_final,$periodo){
?>
