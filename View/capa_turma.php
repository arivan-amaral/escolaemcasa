...
<style>
  .excel-button {
    ...
    /* Cor verde semelhante ao símbolo do Excel */
    color: white;
    border: none;
    padding: 10px 20px;
    text-align: center;
...
<body>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class=WordSection1>
          ...
          <table class=landscape border=0 cellspacing=0 cellpadding=0 style=' border-collapse:collapse;mso-yfti-tbllook:1184;
 mso-padding-alt:0cm 3.5pt 0cm 3.5pt'>
                  ...
                  <span style='mso-ignore:vglayout'>
                    <table cellpadding=0 cellspacing=0 align=left>
                      ...
                      <tr>
                        <td></td>
                        <td>
                          <img width=60 height=75 src="imagens/logo.png" v:shapes="Imagem_x0020_2">
                        </td>
                      </tr>
                    </table>
   ...
   height:15.75pt; text-align: center;'>
                <p class=MsoNormal style='margin-bottom:9pt;line-height:normal'><b><span style='font-size:12.0pt;font-family:"Tw Cen MT Condensed",sans-serif;
   mso-fareast-font-family:"Times New Roman";mso-bidi-font-family:Calibri;
   color:black;mso-fareast-language:PT-BR'><?php echo $_SESSION['ORGAO']; ?><o:p></o:p></span></b></p>

                <p class=MsoNormal style='margin-bottom:0cm;line-height:normal'><b><span style='font-size:12.0pt;font-family:"Tw Cen MT Condensed",sans-serif;
     mso-fareast-font-family:"Times New Roman";mso-bidi-font-family:Calibri;
