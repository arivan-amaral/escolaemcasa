...
<div class="content-wrapper" style="min-height: 529px;">
    ...
    <div class="row">
          ...
          <div class="col-md-12">
                    ...
                    <?php 
                      $result=pesquisar_imagem_professor($conexao, $idprofessor);
                      $cont=0;
            ...
            <form class="mt-12" action="../Controller/Alterar_foto_funcionario.php" method="post"  enctype="multipart/form-data">
