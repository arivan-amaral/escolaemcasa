        ...
        <div class="col-md-1">
         ...
         <div class="col-md-10">
            <div class="card card-primary">
                  ...
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form action="../Controller/Cadastrar_turma.php" method="POST">
                    <div class="card-body">

                      <div class="form-group">
                        <label for="exampleInputEmail1">Nome da turma</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" name="nome" placeholder="EX: jARDIM I, EX2: 1º ANO" required="">
                      </div>

                      <div class="form-group">
                        <label for="exampleInputEmail1">Nível escolar</label>
                        <select class="form-control" id="exampleInputEmail1" name="nivel_escolar" required="">
                            <option > </option>
