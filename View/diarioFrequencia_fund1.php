...
function diario_frequencia_pagina_final_fund2($conexao,$idescola,$idturma,$iddisciplina,$inicio,$fim,
    ...
    // Larguras fixas para células de controle (em pt)
    $LARGURA_COLUNA_NUMERO_PT = 15.4; // Coluna do número do aluno (1, 2, 3...)
    $LARGURA_COLUNA_ALUNO_PT = 180; // Largura ajustada para o Nome do Aluno
    $LARGURA_COLUNA_FALTAS_PT = 12.0; // Coluna do Total de Faltas
...
<div class=WordSection1>
    ...
    <table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 style='width: 100%;'>
        ...
        <tr style='mso-yfti-irow:10;height:12.0pt'>
            ...
            <td width='<?php echo $LARGURA_COLUNA_NUMERO_PT; ?>' nowrap rowspan=2 style='width:<?php echo $LARGURA_COLUNA_NUMERO_PT; ?>pt; border-top:none;border-left:
            ...
            <td width='<?php echo $LARGURA_COLUNA_ALUNO_PT; ?>' nowrap rowspan=2 style='width:<?php echo $LARGURA_COLUNA_ALUNO_PT; ?>pt;border-top:none;
            ...
            <td width='<?php echo $LARGURA_COLUNA_FALTAS_PT; ?>' nowrap rowspan=2 style='width:<?php echo $LARGURA_COLUNA_FALTAS_PT; ?>pt; border-top::solid windowtext 1.0pt; border-left:
                solid windowtext 1.0pt;border-bottom:solid black 1.0pt;border-right:solid windowtext 1.0pt;
        ...
        <tr style='mso-yfti-irow:11;height:58.75pt'>
            <?php
            // O loop agora vai de $inicio até ($inicio + $limite_aula), garantindo que todas as $limite_aula colunas sejam preenchidas.
        ...
        foreach ($res_alunos as $value) {
            ...
            <tr style='mso-yfti-irow:<?php echo 12 + $conta; ?>;height:13.5pt'>
                ...
                <td width='<?php echo $LARGURA_COLUNA_NUMERO_PT; ?>' style='width:<?php echo $LARGURA_COLUNA_NUMERO_PT; ?>pt;border:solid windowtext 1.0pt;border-top:
                ...
                <td width='<?php echo $LARGURA_COLUNA_ALUNO_PT; ?>' nowrap valign=bottom style='width:<?php echo $LARGURA_COLUNA_ALUNO_PT; ?>pt;border:none;
                ...
                ?>
                <td width='<?php echo $LARGURA_COLUNA_FALTAS_PT; ?>' style='width:<?php echo $LARGURA_COLUNA_FALTAS_PT; ?>pt;border:solid windowtext 1.0pt;border-top:
                    none;mso-border-left-alt:solid windowtext 1.0pt;mso-border-bottom-alt:solid windowtext .5pt;
                    mso-border-right-alt:solid windowtext 1.0pt;background:white;padding:0cm 3.5pt 0cm 3.5pt;
                    height:13.5pt'>
                    <p class=MsoNormal align=center style='margin-bottom:0cm;text-align:center;
