...
<input type="hidden" name="idescola2" id="idescola" value="<?php echo $idescola; ?>">
<input type="hidden" name="idturma2" id="idturma" value="<?php echo $idturma; ?>">
<input type="hidden" name="iddisciplina2" id="iddisciplina" value="<?php echo $iddisciplina; ?>">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <center>
            ...
            <h1>ATENÇÃO, NÃO LANÇAR NOTA ANTES DAS 16:30, <font color="RED">SERVIDOR EM MANUTENÇÃO</font></h1>
