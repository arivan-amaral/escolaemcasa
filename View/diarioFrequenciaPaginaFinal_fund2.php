...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 style='width: 100%;'>
 ...
 <tr style='mso-yfti-irow:<?php echo 12 + $conta; ?>;height:13.5pt'>
  ...
  <p class=MsoNormal align=center style='margin-bottom:0cm;text-align:center;
   line-height:normal'><span class="nota-cell">
   <?php echo ($nota_final_av3 > 0) ? number_format($nota_final_av3, 1, ',', '') : ''; ?>
   <o:p></o:p></span></p>
  </td>
 ...
 <?php
 $conta++;
 // Se for a última linha da página, quebra o loop para dar espaço para o footer
 // Este é o final do código que você forneceu, portanto, mantenho o fechamento aqui.
 if ($conta > $limite_data) {
  break;
 }
 }
 ?>
...
// A função auxiliar converte_data, se não estiver definida, é definida no código.
// As funções listar_aluno_da_turma_ata_resultado_final, listar_aluno_da_turma_ata_resultado_final_matricula_concluida
// e variáveis globais como $_SESSION['ORGAO'] devem ser definidas fora desta função para que ela funcione corretamente.
?>