...
function diario_frequencia_pagina_final_fund2($conexao,$idescola,$idturma,$iddisciplina,$inicio,$fim,
  ...
  // NOVAS CONSTANTES DE LAYOUT
  $LARGURA_COLUNA_NOTA_PT = 45; // Largura para cada coluna de nota/média
?>
...
<div class=WordSection1>
  ...
  <table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 style='width: 100%;'>
      ...
      <td width=261 nowrap rowspan=2 style='width:195.55pt;border-top:none;
        ...
        <p class=MsoNormal align=center style='margin-bottom:0cm;text-align:center;
          ...
          color:black;mso-fareast-language:PT-BR'>Aula/Data<o:p></o:p></span></b></p>
            ...
            <td width='<?php echo $LARGURA_COLUNA_NOTA_PT; ?>' nowrap rowspan=2 style='width:<?php echo $LARGURA_COLUNA_NOTA_PT; ?>pt; border-top:solid windowtext 1.0pt; border-left:
        solid windowtext 1.0pt;border-bottom:solid black 1.0pt;border-right:solid windowtext 1.0pt;
    ...
    foreach ($res_alunos as $value) {
      ...
      // =================================================================
      // CÁLCULO DAS NOTAS E MÉDIA PARA ESTE ALUNO
      // =================================================================
      ...
      // Formatar média para 2 casas decimais (ou o padrão desejado)
      ...
      <tr style='mso-yfti-irow:<?php echo 12 + $conta; ?>;height:13.5pt'>
        ...
        for ($i = $inicio; $i < ($inicio + $limite_aula); $i++) {
          ...
          if ($i < $limite_loop_data_aula) {
            ...
            if ($is_present === 1) {
              $presenca = "<span style='color:green;'>P</span>";
            } elseif ($is_present === 0) {
              $presenca = "<span style='color:red;'>F</span>";
            }
          }
          ...
          <td width='<?php echo $LARGURA_COLUNA_PT; ?>' style='width:<?php echo $LARGURA_COLUNA_PT; ?>pt;border:solid windowtext 1.0pt;
            border-left:none;<?php echo $is_even ? 'background:#D9D9D9;' : ''; ?>mso-border-left-alt:solid windowtext 1.0pt;mso-border-alt:
            solid windowtext 1.0pt;mso-border-right-alt:solid windowtext .5pt;padding:0cm 0pt 0cm 0pt;height:13.5pt'>
            <p class=MsoNormal align=center style='margin-bottom:0cm;text-align:center;
              line-height:normal'>
        ...
        ?>
                ...
                <td width='<?php echo $LARGURA_COLUNA_NOTA_PT; ?>' style='width:<?php echo $LARGURA_COLUNA_NOTA_PT; ?>pt;border:solid windowtext 1.0pt;border-top:
        ...
        <td width='<?php echo $LARGURA_COLUNA_NOTA_PT; ?>' style='width:<?php echo $LARGURA_COLUNA_NOTA_PT; ?>pt;border:solid windowtext 1.0pt;border-top:
          none;background:#D9D9D9;padding:0cm 3.5pt 0cm 3.5pt;height:13.5pt'>
          <p class=MsoNormal align=center style='margin-bottom:0cm;text-align:center;
            line-height:normal'><b><span class="nota-cell">
            <?php echo $media_formatada; ?>
            <o:p></o:p></span></b></p>
        </td>

        <td width=60 nowrap style='width:12.0pt;border:solid windowtext 1.0pt;border-top:
          none;background:white;padding:0cm 3.5pt 0cm 3.5pt;height:13.5pt'>
          <p class=MsoNormal align=center style='margin-bottom:0cm;text-align:center;
      ...
      <?php
      $conta++;
    } // Fim do foreach ($res_alunos)
    ?>

  </table>
</div>
<?php } // Fim da função diario_frequencia_pagina_final_fund2 ?>