<?php 
function diario_frequencia_pagina_final_fund1($conexao, $idescola, $idturma, $iddisciplina, $inicio, $fim, $conta_aula, $conta_data, $limite_data, $limite_aula, $periodo_id, $idserie, $descricao_trimestre, $data_inicio_trimestre, $data_fim_trimestre, $ano_letivo, $seguimento,$mapa_total_faltas_pagina1) {
...
<div class="WordSection1">
    ...
    <table class="tabela-diario">
        ...
        foreach ($res_alunos as $aluno) {
            ...
            $total_faltas=0;
              if (!isset($mapa_total_faltas_pagina1[$idaluno])) {
                  $mapa_total_faltas_pagina1[$idaluno] = 0;
              }
