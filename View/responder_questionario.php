...
adiciona_discurciva = function (title, filter) {
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-md-12"> 
          ...
          $selec_questionario=selecionar_questionario_data($conexao,$iddisciplina,$idturma,$data_atual,$questionario_id);
...
<input type='hidden' id='btnEnviar' value='Enviar' />
            ...
            if ($id==$alternativa_id){
              echo "                                                
              <div class='custom-control custom-radio'>
              <input type='radio' id='customRadio$id$cont' name='alternativa$questao_id' class='custom-control-input' onclick='resposta_justificada($id);
              ...
              echo "                                                
              <div class='custom-control custom-radio'>
              <input type='radio' id='customRadio$id$cont' name='alternativa$questao_id' class='custom-control-input' onclick='resposta_justificada($id);adiciona_justificada_marcacao($id);' value='$id'>
