        ...
        <div class="col-md-1">
         ...
         <div class="col-md-10">
            <div class="card card-primary">
                  ...
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form action="../Controller/Cadastrar_disciplina.php" method="POST">
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" name="carga_horario" placeholder="ex: 180" required="">
                      </div>
